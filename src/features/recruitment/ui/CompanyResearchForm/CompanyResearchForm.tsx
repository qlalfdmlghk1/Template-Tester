...
export function CompanyResearchForm({
  ...
  return (
    <form
      ...
      className="flex flex-col gap-3 p-5 md:p-6 bg-surface border border-border rounded-lg"
    >
